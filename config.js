...
let divChapter1 =
  "<p style='max-width:600px; margin-left:auto; margin-right:auto'>The Atlantic Coast population is only one part of the range. In the late spring and early summer, piping plovers travel to the coast, Great Lake and Northern Great Plains, where they <span style='color:#023e8a'>mate, hatch, forage</span>, and then bring chicks back to the <span style='color:#7fb6c6'>southern states and even further</span>.</p>";
